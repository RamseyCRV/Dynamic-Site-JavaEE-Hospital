...
<div id="bodyContainer">
    ...
    <div id="rightSection" style="float: Right; width: 1600px; height: 800px; background-color: azure">
        ...
        <form method="post" action="reg" align="center" style="margin-top: 100px;">
            <img src="register.png">
            <table align="center" style="color: darkblue; margin-top:35px;">
				
                <tr>
                    <td>First Name:</td>
                    <td><input type="text" name="Fname" style="border-color:darkblue;border-radius:5px;"></td>
                </tr>
                <tr>
                    <td>Last Name:</td>
                    <td><input type="text" name="Lname" style="border-color:darkblue;border-radius:5px;"></td>
                </tr>


                <tr>
                    <td>User:</td>
                    <td><input type="text" name="User" style="border-color:darkblue;border-radius:5px;"></td>
                </tr>
                ...
                <tr>
                    <td>Phone Number:</td>
                    <td><input type="text" name="Telefon" style="border-color:darkblue;border-radius:5px;"></td>
                </tr>

                <tr>
                    <td>CNP:</td>
                    <td><input type="text" name="Cnp" style="border-color:darkblue;border-radius:5px;"></td>
                </tr>

                <tr>
                    <td></td>
                    <td><input type="submit" value="Register" style="background-color:gold;color:darkblue;border-radius:5px;"></td>
                </tr>
